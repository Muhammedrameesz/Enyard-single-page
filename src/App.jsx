      ...
      <section className="grid grid-cols-1 md:grid-cols-2 px-6 md:px-10 mx-auto max-w-6xl gap-10">
        ...
        >
          ...
          <p className="text-gray-300">
            ...
            ut! Incidunt autem qui enim ullam laborum blanditiis, et, debitis ex
            minima aspernatur repudiandae nisi corporis cumque eaque adipisci
            delectus.
          </p>
          <button
